<template>
	<view class="template-edit tn-safe-area-inset-bottom">
		...
		<view class="tn-safe-area-inset-bottom" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
			<view class="tn-text-bold tn-text-lg tn-padding-sm">请选择你要完善的信息类型</view>
			
			<view class="CampCards">
				<view class="card" v-for="index in 4" @click="tn">
					<view class="main border-content tn-border-solid">
						<view class="rightTopTag tn-icon-success-circle tn-color-green"></view>
						<view class="avatar">
...
<script>
	...
	export default {
		...
		methods: {
			...
			tn(){
				uni.navigateTo({
					url:'/campPages/campInfoType/campInfoSelect'
				})
			}
		}
	}
